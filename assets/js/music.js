...
const MasterOfPuppets = new Game(
    [
        m.notes[11], m.notes[11], m.notes[12], m.notes[12], m.notes[3],
        m.notes[2], m.notes[1], m.notes[1], m.notes[3], m.notes[2],
        m.notes[1], m.notes[3], m.notes[11], m.notes[11], m.notes[11],
        m.notes[1], m.notes[3], m.notes[2], m.notes[1], m.notes[1],
        m.notes[3], m.notes[2], m.notes[1], m.notes[11], m.notes[11],
        m.notes[12], m.notes[2], m.notes[1], m.notes[3], m.notes[2],
        m.notes[1], m.notes[3], m.notes[2], m.notes[1], m.notes[12],
        m.notes[13], m.notes[12], m.notes[1], m.notes[2], m.notes[1],
        m.notes[1], m.notes[1], m.notes[1], m.notes[3], m.notes[2],
        m.notes[7], m.notes[7], m.notes[8], m.notes[3], m.notes[2],
        m.notes[1], m.notes[3], m.notes[2], m.notes[1], m.notes[1],
        m.notes[3], m.notes[2], m.notes[1], m.notes[3], m.notes[1],
        m.notes[3], m.notes[2], m.notes[1], m.notes[3], m.notes[2],
        m.notes[1], m.notes[3], m.notes[2], m.notes[1], m.notes[3],
        m.notes[2], m.notes[1], m.notes[3], m.notes[2], m.notes[1],
        m.notes[1], m.notes[12], m.notes[3], m.notes[1], m.notes[12],
        m.notes[3], m.notes[1], m.notes[12], m.notes[3], m.notes[1],
        m.notes[12], m.notes[3], m.notes[1], m.notes[12], m.notes[3],
        m.notes[1], m.notes[2], m.notes[3], m.notes[1], m.notes[2],
        m.notes[3], m.notes[1], m.notes[1], m.notes[3], m.notes[2],
        m.notes[1], m.notes[3], m.notes[2], m.notes[1], m.notes[1],
        m.notes[3], m.notes[2], m.notes[1], m.notes[3], m.notes[1],
        ...
        m.notes[1], m.notes[3], m.notes[2], m.notes[1], m.notes[1],
        m.notes[2], m.notes[1], m.notes[8], m.notes[1], m.notes[1],
        m.notes[3], m.notes[2], m.notes[9], m.notes[3], m.notes[9],
        m.notes[3], m.notes[2], m.notes[9], m.notes[3], m.notes[2],
        m.notes[9], m.notes[9], m.notes[3], m.notes[2], m.notes[9],
        m.notes[3], m.notes[9], m.notes[3], m.notes[2], m.notes[1],
        m.notes[3], m.notes[2], m.notes[1], m.notes[3], m.notes[2],
        m.notes[1], m.notes[3], m.notes[2], m.notes[1], m.notes[3],
        m.notes[11], m.notes[5], m.notes[5], m.notes[5], m.notes[0],
        m.notes[1], m.notes[11], m.notes[3], m.notes[1], m.notes[11],
        m.notes[3], m.notes[1], m.notes[11], m.notes[3], m.notes[1],
        m.notes[11], m.notes[5], m.notes[5], m.notes[11], m.notes[3],
        m.notes[1], m.notes[11], m.notes[10], m.notes[1], m.notes[3],
        m.notes[10], m.notes[12], m.notes[13], m.notes[1], m.notes[3],
        m.notes[1], m.notes[3], m.notes[2], m.notes[9], m.notes[3],
        m.notes[2], m.notes[1], m.notes[4], m.notes[3], m.notes[2],
        m.notes[1], m.notes[6], m.notes[6], m.notes[6], m.notes[2],
        m.notes[1], m.notes[3], m.notes[2], m.notes[1], m.notes[1],
        m.notes[3], m.notes[2], m.notes[1], m.notes[3], m.notes[1],
        m.notes[3], m.notes[2], m.notes[1], m.notes[3], m.notes[2],
        m.notes[1], m.notes[3], m.notes[2], m.notes[1], m.notes[3],
        m.notes[2], m.notes[1], m.notes[1], m.notes[2], m.notes[1],
        m.notes[8], m.notes[0], m.notes[0], m.notes[3], m.notes[2],
        m.notes[0], m.notes[5], m.notes[2], m.notes[0], m.notes[5],
        m.notes[2], m.notes[1], m.notes[1], m.notes[5], m.notes[2],
        m.notes[10], m.notes[5], m.notes[10], m.notes[5], m.notes[2],
        m.notes[10], m.notes[5], m.notes[2], m.notes[10], m.notes[10],
        m.notes[5], m.notes[8], m.notes[11], m.notes[5], m.notes[11],
        m.notes[3], m.notes[8], m.notes[11], m.notes[3], m.notes[8],
        m.notes[0], m.notes[3], m.notes[8], m.notes[0], m.notes[3],
        m.notes[8], m.notes[0], m.notes[0], m.notes[8], m.notes[11],
        m.notes[8], m.notes[1], m.notes[1], m.notes[3], m.notes[8],
        m.notes[1], m.notes[3], m.notes[1], m.notes[3], m.notes[2],
        m.notes[1], m.notes[3], m.notes[2], m.notes[1], m.notes[1],
        m.notes[3], m.notes[2], m.notes[1], m.notes[3], m.notes[1],
        m.notes[3], m.notes[2], m.notes[1], m.notes[3], m.notes[2],
        m.notes[1], m.notes[3], m.notes[2], m.notes[1], m.notes[3],
        m.notes[12], m.notes[1], m.notes[3], m.notes[12], m.notes[1],
        m.notes[1], m.notes[12], m.notes[3], m.notes[1], m.notes[12],
        m.notes[3], m.notes[1], m.notes[12], m.notes[3], m.notes[1],
        m.notes[2], m.notes[3], m.notes[1], m.notes[2], m.notes[3],
        m.notes[1], m.notes[2], m.notes[3], m.notes[1], m.notes[2],
    ...
    [
